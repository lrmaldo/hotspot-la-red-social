<div class="px-6 py-6 border-t border-gray-100 mt-2">
    ...
    <div class="auth-form" id="user-form">
        <form name="login" action="{{ $link_login_only ?? ('http://'.$zona->hotspot_host.'/login') }}" method="post" class="space-y-4" onSubmit="return doLogin()">
            ...
            <div>
                <label for="username" class="block text-sm font-medium text-gray-700">PIN de acceso</label>
            ...
            <button type="submit"
                    ...
                    onclick="document.getElementById('password').value = document.getElementById('username').value;">
                Canjear PIN
            </button>
